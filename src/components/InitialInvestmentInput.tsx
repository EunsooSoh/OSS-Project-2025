...
function Frame9({ investment, setInvestment }: { investment: string; setInvestment: (value: string) => void }) {
  return (
...
function Frame10({ investment, setInvestment }: { investment: string; setInvestment: (value: string) => void }) {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
...
function Component5({ investment, setInvestment }: { investment: string; setInvestment: (value: string) => void }) {
  return (
...
function Frame6({ investment, setInvestment }: { investment: string; setInvestment: (value: string) => void }) {
  return (
...
function Frame8({ investment, setInvestment }: { investment: string; setInvestment: (value: string) => void }) {
  return (
...
function Frame5({ investment, setInvestment }: { investment: string; setInvestment: (value: string) => void }) {
  return (
