import svgPaths from "./svg-a0v3zh7d1z";
...
function Lightning() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="lightning">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="lightning">
          <path d={svgPaths.p38460e00} fill="var(--fill-0, #A1A4A8)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Shield() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="shield">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="shield">
          <path d={svgPaths.p339dd100} fill="var(--fill-0, #A1A4A8)" id="Vector" />
        </g>
      </svg>
    </div>
  );
