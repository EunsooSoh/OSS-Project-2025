import svgPaths from "./svg-jt07di20lr";
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1fa9a4] text-[0px] text-nowrap tracking-[0.16px]">
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid leading-[1.5] text-[16px] underline whitespace-pre">EMA 12</p>
      </div>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1fa9a4] text-[0px] text-nowrap tracking-[0.16px]">
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid leading-[1.5] text-[16px] underline whitespace-pre">EMA 26</p>
      </div>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1fa9a4] text-[0px] text-nowrap tracking-[0.16px]">
        <p className="[text-underline-position:from-font] decoration-solid leading-[1.5] text-[16px] underline whitespace-pre">KOSPI</p>
      </div>
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1fa9a4] text-[0px] text-nowrap tracking-[0.16px]">
        <p className="[text-underline-position:from-font] decoration-solid leading-[1.5] text-[16px] underline whitespace-pre">STOCH_%K</p>
      </div>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1fa9a4] text-[0px] text-nowrap tracking-[0.16px]">
        <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid leading-[1.5] text-[16px] underline whitespace-pre">BB_BW</p>
      </div>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
      <div className="flex flex-col font-['Pretendard:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#1fa9a4] text-[0px] text-nowrap tracking-[0.16px]">
        <p className="[text-underline-position:from-font] decoration-solid leading-[1.5] text-[16px] underline whitespace-pre">Position</p>
      </div>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <Frame37 />
      <div className="flex flex-col font-['Pretendard:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#151b26] text-[14px] tracking-[0.14px] w-full">
        <p className="leading-[1.45]">모멘텀이 둔화되며 상승 추세의 에너지가 약화되고 있습니다.</p>
      </div>
    </div>
  );
}
