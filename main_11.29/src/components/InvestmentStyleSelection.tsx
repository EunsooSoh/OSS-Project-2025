    ...
    <div className="relative shrink-0 w-full">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[12px] items-start px-[20px] py-0 relative w-full">
          <AggressiveOption isSelected={selectedStyle === 'aggressive'} onClick={() => setSelectedStyle('aggressive')} />
          <ModerateOption isSelected={selectedStyle === 'moderate'} onClick={() => setSelectedStyle('moderate')} />
          <StableOption isSelected={selectedStyle === 'stable'} onClick={() => setSelectedStyle('stable')} />
        </div>
      </div>
    </div>
  );
